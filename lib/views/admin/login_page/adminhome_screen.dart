                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            image.isEmpty || image == null ? CircleAvatar(
                              radius: 5.sp,
                            ...
                            SizedBox(
                                width: 50.w,
                                child: Text("$displayName",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 4.sp,overflow: TextOverflow.ellipsis),)),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text("Users",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontSize: 5.sp),),
                                          Text("0",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal),),
                                        ],
                                      ),
                                    ],
                                  ),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text("Galleries",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontSize: 5.sp),),
                                          Text("0",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal),),
                                        ],
                                      ),
                                    ],
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text("Admins",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontSize: 5.sp),),
                                          Text("0",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal),),
                                        ],
                                      ),
                                    ],
