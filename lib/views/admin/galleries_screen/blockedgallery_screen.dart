...
class galleryblocked_screen extends StatefulWidget {
  const galleryblocked_screen({Key? key}) : super(key: key);

  @override
  State<galleryblocked_screen> createState() => _galleryblocked_screenState();
}

class _galleryblocked_screenState extends State<galleryblocked_screen> {
                      ...
                      children: [
                        ...
                        DefaultTextStyle(
                          ...
                          child: AnimatedTextKit(
                            animatedTexts: [
                              WavyAnimatedText('Blocked Gallery',),
                            ],
