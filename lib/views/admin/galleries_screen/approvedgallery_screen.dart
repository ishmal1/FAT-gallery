...
import 'package:login_signup/views/admin/galleries_screen/waitinggallery_screen.dart';
...
class galleryapproved_screen extends StatefulWidget {
  const galleryapproved_screen({Key? key}) : super(key: key);

  @override
  State<galleryapproved_screen> createState() => _galleryapproved_screenState();
}

class _galleryapproved_screenState extends State<galleryapproved_screen> {
                      ...
                      children: [
                        ...
                        DefaultTextStyle(
                          ...
                          child: AnimatedTextKit(
                            animatedTexts: [
                              WavyAnimatedText('Approved Gallery',),
                            ],
