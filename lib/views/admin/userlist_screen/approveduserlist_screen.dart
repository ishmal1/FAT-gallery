...
import 'blockeduserlist_screen.dart';
import 'components/blocked_tab.dart';
import 'components/getuserlist_screen.dart';

class approveduserlist_screen extends StatefulWidget {
  const approveduserlist_screen({Key? key}) : super(key: key);

  @override
  State<approveduserlist_screen> createState() => _approveduserlist_screenState();
}

class _approveduserlist_screenState extends State<approveduserlist_screen> {
                    ...
                    children: [
                      ...
                      DefaultTextStyle(
                        ...
                        child: AnimatedTextKit(
                          animatedTexts: [
                            WavyAnimatedText('Approved Users',),
                          ],
