...
import 'blockadminlist_screen.dart';
import 'components/blocked_tab.dart';
import 'components/getadminlist_screen.dart';

class approvedadminlist_screen extends StatefulWidget {
  @override
  _approvedadminlist_screenState createState() => _approvedadminlist_screenState();
}

class _approvedadminlist_screenState extends State<approvedadminlist_screen> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            Get.to(blockedadminlist_screen());
                          },
                    ...
                    DefaultTextStyle(
                      ...
                      child: AnimatedTextKit(
                        animatedTexts: [
                          WavyAnimatedText('Approved Admins',),
                        ],
                    ...
                    Expanded(
                      child: StreamBuilder(
                        stream: admin
                            .where('role', isEqualTo: 'Admin').where('status', isEqualTo: "Approved")
                            .snapshots(),
